...
namespace Game.Views
{
    public interface ILaneView
    {
        ...
        bool TryGetLaneIndexAtScreenPoint(Vector2 screenPoint, out int laneIndex);
        bool TryGetLaneUnitSlotAtScreenPoint(Vector2 screenPoint, int laneIndex, int unitCount, out int slotIndex);
